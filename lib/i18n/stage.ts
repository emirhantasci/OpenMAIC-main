...
export const stageTrTR = {
  stage: {
    currentScene: 'Mevcut Sahne',
    generating: 'Oluşturuluyor...',
    paused: 'Duraklatıldı',
    generationFailed: 'Oluşturma başarısız',
    confirmSwitchTitle: 'Sahne Değiştir',
    confirmSwitchMessage:
      'Bir konu şu anda devam ediyor. Sahne değiştirmek mevcut konuyu sonlandıracak. Emin misiniz?',
    generatingNextPage: 'Sahne oluşturuluyor, lütfen bekleyin...',
    fullscreen: 'Tam Ekran',
    exitFullscreen: 'Tam Ekrandan Çık',
  },
  whiteboard: {
    title: 'Etkileşimli Beyaz Tahta',
    open: 'Beyaz Tahtayı Aç',
    clear: 'Beyaz Tahtayı Temizle',
    minimize: 'Beyaz Tahtayı Küçült',
    ready: 'Beyaz tahta hazır',
    readyHint: 'AI tarafından eklenen öğeler burada görünecek',
    clearSuccess: 'Beyaz tahta başarıyla temizlendi',
    clearError: 'Beyaz tahta temizlenemedi: ',
    resetView: 'Görünümü Sıfırla',
    restoreError: 'Beyaz tahta geri yüklenemedi: ',
    history: 'Geçmiş',
    restore: 'Geri Yükle',
    noHistory: 'Henüz geçmiş yok',
    restored: 'Beyaz tahta geri yüklendi',
    elementCount: '{count} öğe',
  },
  quiz: {
    title: 'Test',
    ...
    multipleChoiceHint: '(Çoktan seçmeli — tüm doğru cevapları işaretleyin)',
    inputPlaceholder: 'Cevabınızı buraya yazın...',
    charCount: 'karakter',
    yourAnswer: 'Cevabınız:',
    notAnswered: 'Cevaplanmadı',
    aiComment: 'AI Değerlendirmesi',
    ...
    correct: 'doğru',
    incorrect: 'yanlış',
    answering: 'Devam Ediyor',
    submitAnswers: 'Cevapları Gönder',
    aiGrading: 'AI değerlendiriyor...',
    aiGradingWait: 'Lütfen bekleyin, cevaplarınız analiz ediliyor',
    quizReport: 'Test Raporu',
    retry: 'Tekrar Dene',
  },
  roundtable: {
    teacher: 'ÖĞRETMEN',
    ...
    discussionEnded: 'Tartışma sona erdi',
    qaEnded: 'Soru-Cevap sona erdi',
    thinking: 'Düşünüyor',
    yourTurn: 'Sıra sizde',
    stopDiscussion: 'Tartışmayı Bitir',
    autoPlay: 'Otomatik oynat',
    autoPlayOff: 'Otomatik oynatmayı durdur',
    speed: 'Hız',
    voiceInput: 'Sesli giriş',
    voiceInputDisabled: 'Sesli giriş devre dışı',
    textInput: 'Metin girişi',
    stopRecording: 'Kaydı durdur',
    startRecording: 'Kayda başla',
  },
  pbl: {
    legacyFormat: 'Bu PBL sahnesi eski format kullanıyor. Lütfen dersi yeniden oluşturun.',
    emptyProject: 'PBL projesi henüz oluşturulmadı. Lütfen ders oluşturma ile oluşturun.',
    roleSelection: {
      title: 'Rolünüzü Seçin',
      description: 'Projede işbirliğine başlamak için bir rol seçin',
    },
    workspace: {
      restart: 'Yeniden Başla',
      confirmRestart: 'Tüm ilerleme sıfırlansın mı?',
      confirm: 'Onayla',
      cancel: 'İptal',
    },
    issueboard: {
      title: 'Görev Panosu',
      noIssues: 'Henüz görev yok',
      statusDone: 'Tamamlandı',
      statusActive: 'Aktif',
      statusPending: 'Bekliyor',
    },
    chat: {
      title: 'Proje Tartışması',
      currentIssue: 'Mevcut Görev',
      mentionHint: 'Soru sormak için @question, incelemeye göndermek için @judge kullanın',
      placeholder: 'Bir mesaj yazın...',
      send: 'Gönder',
      welcomeMessage:
        'Merhaba! Bu görev için Soru Ajanınızım: "{title}"\n\nÇalışmanıza rehberlik etmek için bazı sorular hazırladım:\n\n{questions}\n\nYardıma ihtiyacınız olduğunda istediğiniz zaman @question yazabilirsiniz!',
      issueCompleteMessage: '"{completed}" görevi tamamlandı! Sonraki görev: "{next}"',
      allCompleteMessage: '🎉 Tüm görevler tamamlandı! Harika iş çıkardınız!',
    },
    guide: {
      ...
      title: 'Yardım',
      step1: {
        title: 'Adım 1: Rol Seçin',
        desc: 'Proje oluşturulduktan sonra listeden bir rol seçin (🟢 ile işaretlenmiş sistem dışı roller)',
      },
      step2: {
        title: 'Adım 2: Görevleri Tamamlayın',
        desc: 'Her görev bir öğrenme hedefini temsil eder:',
        s1: {
          title: 'Mevcut görevi inceleyin',
          desc: 'Görevin başlığını, açıklamasını ve sorumlusunu kontrol edin',
        },
        s2: {
          title: 'Rehberlik alın',
          example: '@question Nereden başlamalıyım?\n@question Bu özelliği nasıl uygulayabilirim?',
          desc: 'Soru Ajanı yönlendirici sorular ve ipuçları sağlar (doğrudan cevap vermez)',
        },
        s3: {
          title: 'Çalışmanızı gönderin',
          example: '@judge İşim bitti, lütfen kontrol edin',
          desc: 'Değerlendirme Ajanı çalışmanızı değerlendirir ve geri bildirim verir:',
          complete: 'Otomatik olarak sonraki göreve geçer',
          revision: 'Geri bildirime göre iyileştirin',
        },
      },
      step3: {
        title: 'Adım 3: Projeyi Tamamlayın',
        desc: 'Tüm görevler tamamlandığında sistem "🎉 Proje Tamamlandı!" mesajı gösterir',
      },
    },
  },
  share: {
    notReady: 'Oluşturma tamamlandıktan sonra kullanılabilir',
  },
} as const;
