...
export const chatTrTR = {
  chat: {
    lecture: 'Ders',
    noConversations: 'Henüz konuşma yok',
    startConversation: 'Sohbete başlamak için bir mesaj yazın',
    noMessages: 'Henüz mesaj yok',
    ended: 'sona erdi',
    unknown: 'Bilinmiyor',
    stopDiscussion: 'Tartışmayı Bitir',
    endQA: 'Soru-Cevabı Bitir',
    tabs: {
      lecture: 'Notlar',
      chat: 'Sohbet',
    },
    lectureNotes: {
      empty: 'Ders oynatıldıktan sonra notlar burada görünecek',
      emptyHint: 'Dersi başlatmak için oynat düğmesine basın',
      pageLabel: 'Sayfa {n}',
      currentPage: 'Mevcut',
    },
    badge: {
  ...
  actions: {
    names: {
      ...
      laser: 'Lazer',
      wb_open: 'Beyaz Tahtayı Aç',
      wb_draw_text: 'Tahta Metni',
      wb_draw_shape: 'Tahta Şekli',
      wb_draw_chart: 'Tahta Grafik',
      wb_draw_latex: 'Tahta Formül',
      wb_draw_table: 'Tahta Tablo',
      wb_draw_line: 'Tahta Çizgi',
      wb_clear: 'Tahtayı Temizle',
      wb_delete: 'Öğeyi Sil',
      wb_close: 'Tahtayı Kapat',
      discussion: 'Tartışma',
    },
    status: {
      inputStreaming: 'Bekleniyor',
      inputAvailable: 'Yürütülüyor',
      outputAvailable: 'Tamamlandı',
      outputError: 'Hata',
      outputDenied: 'Reddedildi',
      running: 'Yürütülüyor',
      result: 'Tamamlandı',
      error: 'Hata',
    },
  ...
  agentBar: {
    readyToLearn: 'Birlikte öğrenmeye hazır mısınız?',
    expandedTitle: 'Sınıf Rol Yapılandırması',
    configTooltip: 'Sınıf rollerini yapılandırmak için tıklayın',
    voiceLabel: 'Ses',
    voiceLoading: 'Yükleniyor...',
    voiceAutoAssign: 'Sesler otomatik atanacak',
  },
  proactiveCard: {
    discussion: 'Tartışma',
    join: 'Katıl',
