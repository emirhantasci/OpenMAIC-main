...
export const settingsTrTR = {
  settings: {
    ...
    theme: 'Tema',
    themeDesc: 'Tema modunu seçin (Açık/Koyu/Sistem)',
    themeOptions: {
      light: 'Açık',
      dark: 'Koyu',
      system: 'Sistem',
    ...
    apiKey: 'API Anahtarı',
    apiKeyDesc: 'API anahtarınızı yapılandırın',
    apiBaseUrl: 'API Uç Noktası URL',
    apiBaseUrlDesc: 'API uç noktası URL\'nizi yapılandırın',
    apiKeyRequired: 'API anahtarı boş olamaz',
    model: 'Model Yapılandırması',
    modelDesc: 'AI modellerini yapılandırın',
    modelPlaceholder: 'Model adı girin veya seçin',
    ttsModel: 'TTS Modeli',
    ttsModelDesc: 'TTS modellerini yapılandırın',
    ttsModelPlaceholder: 'TTS model adı girin veya seçin',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    testConnection: 'Bağlantıyı Test Et',
    testConnectionDesc: 'Mevcut API yapılandırmasını test edin',
    testing: 'Test ediliyor...',
    agentSettings: 'Ajan Ayarları',
    agentSettingsDesc:
      'Konuşmaya katılacak ajanları seçin. Tek ajan modu için 1, çoklu ajan işbirliği modu için birden fazla seçin.',
    agentMode: 'Ajan Modu',
    agentModePreset: 'Hazır Ayar',
    agentModeAuto: 'Otomatik Oluştur',
    agentModeAutoDesc: 'AI uygun rolleri otomatik olarak oluşturacak',
    autoAgentCount: 'Ajan Sayısı',
    autoAgentCountDesc: 'Otomatik oluşturulacak ajan sayısı (öğretmen dahil)',
    atLeastOneAgent: 'Lütfen en az 1 ajan seçin',
    singleAgentMode: 'Tek Ajan Modu',
    directAnswer: 'Doğrudan Yanıt',
    multiAgentMode: 'Çoklu Ajan Modu',
    agentsCollaborating: 'İşbirlikçi Tartışma',
    agentsCollaboratingCount: 'İşbirlikçi tartışma için {count} ajan seçildi',
    maxTurns: 'Maksimum Tartışma Turu',
    maxTurnsDesc:
      'Ajanlar arasındaki maksimum tartışma turu sayısı (her ajan eylemleri tamamlayıp yanıt verirse bir tur sayılır)',
    priority: 'Öncelik',
    actions: 'Eylemler',
    actionCount: '{count} eylem',
    selectedAgent: 'Seçilen Ajan',
    selectedAgents: 'Seçilen Ajanlar',
    required: 'Zorunlu',
    agentNames: {
      'default-1': 'AI Öğretmen',
      'default-2': 'AI Asistan',
      'default-3': 'Sınıf Soytarısı',
      'default-4': 'Meraklı Zihin',
      'default-5': 'Not Tutucu',
      'default-6': 'Derin Düşünür',
    },
    agentRoles: {
      teacher: 'Öğretmen',
      assistant: 'Asistan',
    ...
    agentDescriptions: {
      'default-1': 'Açık ve düzenli anlatımlarla ana öğretmen',
      'default-2': 'Öğrenmeyi destekler ve önemli noktaları açıklar',
      'default-3': 'Sınıfa enerji ve mizah katar',
      'default-4': 'Her zaman meraklı, neden ve nasıl sormayı sever',
      'default-5': 'Özenle ders notlarını kaydeder ve düzenler',
      'default-6': 'Derinlemesine düşünür ve konuların özünü araştırır',
    },
    close: 'Kapat',
    save: 'Kaydet',
    providers: 'Dil Modeli',
    addProviderDescription: 'Kullanılabilir AI modellerini genişletmek için özel model sağlayıcılar ekleyin',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    providerTypes: {
      openai: 'OpenAI Protokolü',
      anthropic: 'Claude Protokolü',
      google: 'Gemini Protokolü',
    },
    modelCount: 'model',
    modelSingular: 'model',
    ...
    contextShort: 'bağ',
    outputWindow: 'Çıktı',
    addProviderButton: 'Ekle',
    addProviderDialog: 'Model Sağlayıcı Ekle',
    providerName: 'Ad',
    providerNamePlaceholder: 'ör. OpenAI Proxy\'m',
    providerNameRequired: 'Lütfen sağlayıcı adı girin',
    providerApiMode: 'API Modu',
    apiModeOpenAI: 'OpenAI Protokolü',
    apiModeAnthropic: 'Claude Protokolü',
    apiModeGoogle: 'Gemini Protokolü',
    defaultBaseUrl: 'Varsayılan Base URL',
    providerIcon: 'Sağlayıcı Simge URL',
    requiresApiKey: 'API Anahtarı Gerekli',
    deleteProvider: 'Sağlayıcıyı Sil',
    deleteProviderConfirm: 'Bu sağlayıcıyı silmek istediğinizden emin misiniz?',
    cannotDeleteBuiltIn: 'Yerleşik sağlayıcı silinemez',
    resetToDefault: 'Varsayılana Sıfırla',
    resetToDefaultDescription:
      'Model listesini varsayılan yapılandırmaya geri yükle (API anahtarı ve Base URL korunacak)',
    resetConfirmDescription:
      'Bu işlem tüm özel modelleri kaldıracak ve yerleşik varsayılan model listesini geri yükleyecek. API anahtarı ve Base URL korunacak.',
    confirmReset: 'Sıfırlamayı Onayla',
    resetSuccess: 'Varsayılan yapılandırmaya başarıyla sıfırlandı',
    saveSuccess: 'Ayarlar kaydedildi',
    saveFailed: 'Ayarlar kaydedilemedi, lütfen tekrar deneyin',
    cannotDeleteBuiltInModel: 'Yerleşik model silinemez',
    cannotEditBuiltInModel: 'Yerleşik model düzenlenemez',
    modelIdRequired: 'Lütfen model ID girin',
    noModelsAvailable: 'Test için kullanılabilir model yok',
    providerMetadata: 'Sağlayıcı Meta Verileri',
    editModel: 'Modeli Düzenle',
    editModelDescription: 'Model yapılandırmasını ve yeteneklerini düzenleyin',
    addNewModel: 'Yeni Model',
    addNewModelDescription: 'Yeni bir model yapılandırması ekleyin',
    modelId: 'Model ID',
    modelIdPlaceholder: 'ör. gpt-4o',
    modelName: 'Görünen Ad',
    modelNamePlaceholder: 'İsteğe bağlı',
    modelCapabilities: 'Yetenekler',
    advancedSettings: 'Gelişmiş Ayarlar',
    contextWindowLabel: 'Bağlam Penceresi',
    contextWindowPlaceholder: 'ör. 128000',
    outputWindowLabel: 'Maksimum Çıktı Token',
    outputWindowPlaceholder: 'ör. 4096',
    testModel: 'Modeli Test Et',
    deleteModel: 'Sil',
    cancelEdit: 'İptal',
    saveModel: 'Kaydet',
    modelsManagementDescription:
      'Bu sağlayıcının modellerini yönetin. Aktif modeli seçmek için "Genel" bölümüne gidin.',
    howToUse: 'Kullanım Kılavuzu',
    step1ConfigureProvider:
      '"Model Sağlayıcılar"a gidin, bir sağlayıcı seçin veya ekleyin ve bağlantı ayarlarını yapılandırın (API anahtarı, Base URL, vb.)',
    step2SelectModel: 'Aşağıdaki "Aktif Model" bölümünden kullanmak istediğiniz modeli seçin',
    step3StartUsing: 'Kaydettikten sonra sistem seçtiğiniz modeli kullanacak',
    activeModel: 'Aktif Model',
    activeModelDescription: 'AI konuşmaları ve içerik oluşturma için kullanılacak modeli seçin',
    selectModel: 'Model Seç',
    searchModels: 'Model ara',
    noModelsFound: 'Eşleşen model bulunamadı',
    noConfiguredProviders: 'Yapılandırılmış sağlayıcı yok',
    configureProvidersFirst:
      'Lütfen soldaki "Model Sağlayıcılar" bölümünden sağlayıcı bağlantı ayarlarını yapılandırın',
    currentlyUsing: 'Şu anda kullanılan',
    ttsSettings: 'Metin-Konuşma',
    asrSettings: 'Konuşma Tanıma',
    audioSettings: 'Ses Ayarları',
    ttsSection: 'Metinden Konuşmaya (TTS)',
    asrSection: 'Otomatik Konuşma Tanıma (ASR)',
    ttsDescription: 'TTS (Text-to-Speech) - Metni konuşmaya dönüştür',
    asrDescription: 'ASR (Automatic Speech Recognition) - Konuşmayı metne dönüştür',
    enableTTS: 'Metin-Konuşmayı Etkinleştir',
    ttsEnabledDescription: 'Etkinleştirildiğinde, ders oluşturma sırasında ses otomatik oluşturulacak',
    ttsVoiceConfigHint:
      'Ajan başına ses, ana sayfadaki "Sınıf Rol Yapılandırması" bölümünden ayarlanabilir',
    enableASR: 'Konuşma Tanımayı Etkinleştir',
    asrEnabledDescription: 'Etkinleştirildiğinde, öğrenciler mikrofon ile sesli giriş yapabilir',
    ttsProvider: 'TTS Sağlayıcı',
    ttsLanguageFilter: 'Dil Filtresi',
    allLanguages: 'Tüm Diller',
    ttsVoice: 'Ses',
    ttsSpeed: 'Hız',
    ttsBaseUrl: 'Base URL',
    ttsApiKey: 'API Anahtarı',
    asrProvider: 'ASR Sağlayıcı',
    asrLanguage: 'Tanıma Dili',
    asrBaseUrl: 'Base URL',
    asrApiKey: 'API Anahtarı',
    enterApiKey: 'API Anahtarı Girin',
    enterCustomBaseUrl: 'Özel Base URL girin',
    browserNativeNote: 'Tarayıcı Yerel ASR yapılandırma gerektirmez ve tamamen ücretsizdir',
    providerOpenAITTS: 'OpenAI TTS (gpt-4o-mini-tts)',
    providerAzureTTS: 'Azure TTS',
    providerGLMTTS: 'GLM TTS',
    providerQwenTTS: 'Qwen TTS (Alibaba Cloud Bailian)',
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerBrowserNativeTTS: 'Tarayıcı Yerel TTS',
    providerOpenAIWhisper: 'OpenAI ASR (gpt-4o-mini-transcribe)',
    providerBrowserNative: 'Tarayıcı Yerel ASR',
    providerQwenASR: 'Qwen ASR (Alibaba Cloud Bailian)',
    providerUnpdf: 'unpdf (Yerleşik)',
    providerMinerU: 'MinerU',
    browserNativeTTSNote:
      'Tarayıcı Yerel TTS yapılandırma gerektirmez ve tamamen ücretsizdir, sistem yerleşik seslerini kullanır',
    testTTS: 'TTS Test Et',
    testASR: 'ASR Test Et',
    testSuccess: 'Test Başarılı',
    testFailed: 'Test Başarısız',
    ttsTestText: 'TTS Test Metni',
    ttsTestSuccess: 'TTS testi başarılı, ses çalındı',
    ttsTestFailed: 'TTS testi başarısız',
    asrTestSuccess: 'Konuşma tanıma başarılı',
    asrTestFailed: 'Konuşma tanıma başarısız',
    asrResult: 'Tanıma Sonucu',
    asrNotSupported: 'Tarayıcı Konuşma Tanıma API\'sini desteklemiyor',
    browserTTSNotSupported: 'Tarayıcı Konuşma Sentezi API\'sini desteklemiyor',
    browserTTSNoVoices: 'Mevcut tarayıcıda kullanılabilir TTS sesi yok',
    microphoneAccessDenied: 'Mikrofon erişimi reddedildi',
    microphoneAccessFailed: 'Mikrofona erişilemedi',
    asrResultPlaceholder: 'Kayıttan sonra tanıma sonucu görüntülenecek',
    useThisProvider: 'Bu Sağlayıcıyı Kullan',
    fetchVoices: 'Ses Listesini Getir',
    fetchingVoices: 'Getiriliyor...',
    voicesFetched: 'Sesler getirildi',
    fetchVoicesFailed: 'Sesler getirilemedi',
    voiceApiKeyRequired: 'API Anahtarı gerekli',
    voiceBaseUrlRequired: 'Base URL gerekli',
    ttsTestTextPlaceholder: 'Dönüştürülecek metni girin',
    ttsTestTextDefault: 'Merhaba, bu bir test konuşmasıdır.',
    startRecording: 'Kayda Başla',
    stopRecording: 'Kaydı Durdur',
    recording: 'Kaydediliyor...',
    transcribing: 'Yazıya dökülüyor...',
    transcriptionResult: 'Yazıya Dökme Sonucu',
    noTranscriptionResult: 'Yazıya dökme sonucu yok',
    baseUrlOptional: 'Base URL (İsteğe Bağlı)',
    defaultValue: 'Varsayılan',
    voiceMarin: 'Önerilen - En İyi Kalite',
    voiceCedar: 'Önerilen - En İyi Kalite',
    voiceAlloy: 'Nötr, Dengeli',
    voiceAsh: 'Sakin, Profesyonel',
    voiceBallad: 'Zarif, Lirik',
    voiceCoral: 'Sıcak, Samimi',
    voiceEcho: 'Erkek, Net',
    voiceFable: 'Anlatımcı, Canlı',
    voiceNova: 'Kadın, Parlak',
    voiceOnyx: 'Erkek, Derin',
    voiceSage: 'Bilge, Sakin',
    voiceShimmer: 'Kadın, Yumuşak',
    voiceVerse: 'Doğal, Akıcı',
    glmVoiceTongtong: 'Varsayılan ses',
    glmVoiceChuichui: 'Chuichui sesi',
    glmVoiceXiaochen: 'Xiaochen sesi',
    glmVoiceJam: 'Jam sesi',
    glmVoiceKazi: 'Kazi sesi',
    glmVoiceDouji: 'Douji sesi',
    glmVoiceLuodo: 'Luodo sesi',
    qwenVoiceCherry: 'Güneşli, sıcak ve doğal',
    qwenVoiceSerena: 'Nazik ve yumuşak',
    qwenVoiceEthan: 'Enerjik ve canlı',
    qwenVoiceChelsie: 'Anime sanal kız arkadaş',
    qwenVoiceMomo: 'Oyuncu ve neşeli',
    qwenVoiceVivian: 'Sevimli ve küstah',
    qwenVoiceMoon: 'Havalı ve yakışıklı',
    qwenVoiceMaia: 'Entelektüel ve nazik',
    qwenVoiceKai: 'Kulaklarınız için SPA',
    qwenVoiceNofish: 'Retrofleks sesler çıkaramayan tasarımcı',
    qwenVoiceBella: 'Sarhoş olmayan küçük loli',
    qwenVoiceJennifer: 'Marka düzeyinde, sinematik Amerikan kadın sesi',
    qwenVoiceRyan: 'Hızlı tempolu, dramatik performans',
    qwenVoiceKaterina: 'Akılda kalıcı ritimli olgun bayan',
    qwenVoiceAiden: 'Yemek yapmayı bilen Amerikalı genç',
    qwenVoiceEldricSage: 'Sakin ve bilge yaşlı',
    qwenVoiceMia: 'Bahar suyu gibi nazik, kar gibi uslu',
    qwenVoiceMochi: 'Çocuksu masumiyetle akıllı küçük yetişkin',
    qwenVoiceBellona: 'Güçlü ses, net telaffuz, canlı karakterler',
    qwenVoiceVincent: 'Savaş ve onur hikâyeleri anlatan benzersiz kısık ses',
    qwenVoiceBunny: 'Süper sevimli loli',
    qwenVoiceNeil: 'Profesyonel haber spikeri',
    qwenVoiceElias: 'Profesyonel eğitmen',
    qwenVoiceArthur: 'Yıllar ve kuru tütün ile yıkanmış sade ses',
    qwenVoiceNini: 'Pirinç keki gibi yumuşak ve yapışkan ses',
    qwenVoiceEbona: 'Fısıltısı paslı bir anahtar gibi',
    qwenVoiceSeren: 'Uyumanıza yardımcı nazik ve rahatlatıcı ses',
    qwenVoicePip: 'Yaramaz ama çocuksu masumiyetle dolu',
    qwenVoiceStella: 'Bağırdığında kararlı hale gelen tatlı kız sesi',
    qwenVoiceBodega: 'Coşkulu İspanyol amca',
    qwenVoiceSonrisa: 'Coşkulu Latin Amerikalı hanım',
    qwenVoiceAlek: 'Savaş milletinin soğukluğu, yün paltonun altındaki sıcaklık',
    qwenVoiceDolce: 'Tembel İtalyan amca',
    qwenVoiceSohee: 'Nazik, neşeli Koreli abla',
    qwenVoiceOnoAnna: 'Yaramaz çocukluk arkadaşı',
    qwenVoiceLenn: 'Takım elbise giyip post-punk dinleyen rasyonel Alman genç',
    qwenVoiceEmilien: 'Romantik Fransız ağabey',
    qwenVoiceAndre: 'Manyetik, doğal ve sakin erkek sesi',
    qwenVoiceRadioGol: 'Futbol şairi Rádio Gol!',
    qwenVoiceJada: 'Canlı Şanghaylı hanım',
    qwenVoiceDylan: 'Pekinli genç',
    qwenVoiceLi: 'Sabırlı yoga öğretmeni',
    qwenVoiceMarcus: 'Geniş yüz, kısa sözler, sağlam kalp - eski Shaanxi tadı',
    qwenVoiceRoy: 'Esprili ve doğrudan Tayvanlı genç',
    qwenVoicePeter: 'Tianjin stand-up profesyonel destekçi',
    qwenVoiceSunny: 'Tatlı Sichuan kızı',
    qwenVoiceEric: 'Chengdu beyefendisi',
    qwenVoiceRocky: 'Esprili Hong Kong erkeği',
    qwenVoiceKiki: 'Tatlı Hong Kong kızı',
    ...
    'lang_af-ZA': 'Afrikaans (Suid-Afrika)',
    'lang_uk-UA': 'Українська (Україна)',
    pdfSettings: 'PDF Ayrıştırma',
    pdfParsingSettings: 'PDF Ayrıştırma Ayarları',
    pdfDescription:
      'Metin çıkarma, görsel işleme ve tablo tanıma destekli PDF ayrıştırma motorunu seçin',
    pdfProvider: 'PDF Ayrıştırıcı',
    pdfFeatures: 'Desteklenen Özellikler',
    pdfApiKey: 'API Anahtarı',
    pdfBaseUrl: 'Base URL',
    mineruDescription:
      'MinerU, tablo çıkarma, formül tanıma ve düzen analizi gibi gelişmiş özellikleri destekleyen ticari bir PDF ayrıştırma hizmetidir.',
    mineruApiKeyRequired: 'Kullanmadan önce MinerU web sitesinden API Anahtarı almanız gerekir.',
    mineruWarning: 'Uyarı',
    mineruCostWarning:
      'MinerU ticari bir hizmettir ve ücret alabilir. Fiyatlandırma detayları için MinerU web sitesine bakın.',
    enterMinerUApiKey: 'MinerU API Anahtarı girin',
    mineruLocalDescription:
      'MinerU, gelişmiş PDF ayrıştırma (tablolar, formüller, düzen analizi) ile yerel dağıtımı destekler. Önce MinerU hizmetinin dağıtılması gerekir.',
    mineruServerAddress: 'Yerel MinerU sunucu adresi (ör. http://localhost:8080)',
    mineruApiKeyOptional: 'Yalnızca sunucuda kimlik doğrulama etkinse gereklidir',
    optionalApiKey: 'İsteğe Bağlı API Anahtarı',
    featureText: 'Metin Çıkarma',
    featureImages: 'Görsel Çıkarma',
    featureTables: 'Tablo Çıkarma',
    featureFormulas: 'Formül Tanıma',
    featureLayoutAnalysis: 'Düzen Analizi',
    featureMetadata: 'Meta Veriler',
    enableImageGeneration: 'AI Görsel Oluşturmayı Etkinleştir',
    imageGenerationDisabledHint:
      'Etkinleştirildiğinde, ders oluşturma sırasında görseller otomatik oluşturulacak',
    imageSettings: 'Görsel Oluşturma',
    imageSection: 'Metinden Görsele',
    imageProvider: 'Görsel Oluşturma Sağlayıcı',
    imageModel: 'Görsel Oluşturma Modeli',
    providerSeedream: 'Seedream (ByteDance)',
    providerQwenImage: 'Qwen Image (Alibaba)',
    providerNanoBanana: 'Nano Banana (Gemini)',
    providerGrokImage: 'Grok Image (xAI)',
    testImageGeneration: 'Görsel Oluşturmayı Test Et',
    testImageConnectivity: 'Bağlantıyı Test Et',
    imageConnectivitySuccess: 'Görsel hizmeti başarıyla bağlandı',
    imageConnectivityFailed: 'Görsel hizmeti bağlantısı başarısız',
    imageTestSuccess: 'Görsel oluşturma testi başarılı',
    imageTestFailed: 'Görsel oluşturma testi başarısız',
    imageTestPromptPlaceholder: 'Test için görsel açıklaması girin',
    imageTestPromptDefault: 'Masada oturan sevimli bir kedi',
    imageGenerating: 'Görsel oluşturuluyor...',
    imageGenerationFailed: 'Görsel oluşturma başarısız',
    enableVideoGeneration: 'AI Video Oluşturmayı Etkinleştir',
    videoGenerationDisabledHint:
      'Etkinleştirildiğinde, ders oluşturma sırasında videolar otomatik oluşturulacak',
    videoSettings: 'Video Oluşturma',
    videoSection: 'Metinden Videoya',
    videoProvider: 'Video Oluşturma Sağlayıcı',
    videoModel: 'Video Oluşturma Modeli',
    providerSeedance: 'Seedance (ByteDance)',
    providerKling: 'Kling (Kuaishou)',
    providerVeo: 'Veo (Google)',
    providerSora: 'Sora (OpenAI)',
    providerGrokVideo: 'Grok Video (xAI)',
    testVideoGeneration: 'Video Oluşturmayı Test Et',
    testVideoConnectivity: 'Bağlantıyı Test Et',
    videoConnectivitySuccess: 'Video hizmeti başarıyla bağlandı',
    videoConnectivityFailed: 'Video hizmeti bağlantısı başarısız',
    testingConnection: 'Test ediliyor...',
    videoTestSuccess: 'Video oluşturma testi başarılı',
    videoTestFailed: 'Video oluşturma testi başarısız',
    videoTestPromptDefault: 'Masada yürüyen sevimli bir kedi',
    videoGenerating: 'Video oluşturuluyor (tahmini 1-2 dk)...',
    videoGenerationWarning: 'Video oluşturma genellikle 1-2 dakika sürer, lütfen sabırlı olun',
    mediaRetry: 'Tekrar Dene',
    mediaContentSensitive: 'Üzgünüz, bu içerik güvenlik kontrolünü tetikledi.',
    mediaGenerationDisabled: 'Oluşturma ayarlarda devre dışı',
    singleAgent: 'Tek Ajan',
    multiAgent: 'Çoklu Ajan',
    selectAgents: 'Ajan Seç',
    noVisionWarning:
      'Mevcut model görüntü desteği sunmuyor. Görseller yine de slaytlara yerleştirilebilir, ancak model görsel içeriği anlayamaz',
    serverConfigured: 'Sunucu',
    serverConfiguredNotice:
      'Yönetici, bu sağlayıcı için sunucuda bir API anahtarı yapılandırdı. Doğrudan kullanabilir veya geçersiz kılmak için kendi anahtarınızı girebilirsiniz.',
    optionalOverride: 'İsteğe bağlı — sunucu yapılandırmasını kullanmak için boş bırakın',
    setupNeeded: 'Kurulum gerekli',
    modelNotConfigured: 'Başlamak için lütfen bir model seçin',
    dangerZone: 'Tehlikeli Bölge',
    clearCache: 'Yerel Önbelleği Temizle',
    clearCacheDescription:
      'Sınıf kayıtları, sohbet geçmişi, ses önbelleği ve uygulama ayarları dahil tüm yerel verileri silin. Bu işlem geri alınamaz.',
    clearCacheConfirmTitle: 'Tüm önbelleği temizlemek istediğinizden emin misiniz?',
    clearCacheConfirmDescription:
      'Bu işlem aşağıdaki tüm verileri kalıcı olarak silecek ve kurtarılamaz:',
    clearCacheConfirmItems:
      'Sınıflar ve sahneler, Sohbet geçmişi, Ses ve görsel önbelleği, Uygulama ayarları ve tercihleri',
    clearCacheConfirmInput: 'Devam etmek için "SİL" yazın',
    clearCacheConfirmPhrase: 'SİL',
    clearCacheButton: 'Tüm Verileri Kalıcı Olarak Sil',
    clearCacheSuccess: 'Önbellek temizlendi, sayfa kısa süre içinde yenilenecek',
    clearCacheFailed: 'Önbellek temizlenemedi, lütfen tekrar deneyin',
    webSearchSettings: 'Web Araması',
    webSearchApiKey: 'Tavily API Anahtarı',
    webSearchApiKeyPlaceholder: 'Tavily API Anahtarınızı girin',
    webSearchApiKeyPlaceholderServer: 'Sunucu anahtarı yapılandırıldı, isteğe bağlı geçersiz kılma',
    webSearchApiKeyHint: 'Web araması için tavily.com\'dan API anahtarı alın',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: 'Sunucu tarafında Tavily API anahtarı yapılandırıldı',
    optional: 'İsteğe Bağlı',
  },
  profile: {
    title: 'Profil',
    defaultNickname: 'Öğrenci',
    chooseAvatar: 'Avatar Seç',
    uploadAvatar: 'Yükle',
    bioPlaceholder: 'Kendinizi tanıtın — AI öğretmen derslerini size göre kişiselleştirecek...',
    avatarHint: 'Avatarınız sınıf tartışmalarında ve sohbetlerde görünecek',
    fileTooLarge: 'Görsel çok büyük — lütfen 5 MB\'dan küçük bir görsel seçin',
    invalidFileType: 'Lütfen bir görsel dosyası seçin',
    editTooltip: 'Profili düzenlemek için tıklayın',
  },
  media: {
    imageCapability: 'Görsel Oluşturma',
    imageHint: 'Slaytlarda görsel oluştur',
    videoCapability: 'Video Oluşturma',
    videoHint: 'Slaytlarda video oluştur',
    ttsCapability: 'Metin-Konuşma',
    ttsHint: 'AI öğretmen sesli anlatır',
    asrCapability: 'Konuşma Tanıma',
    asrHint: 'Tartışma için sesli giriş',
    provider: 'Sağlayıcı',
    model: 'Model',
    voice: 'Ses',
    speed: 'Hız',
